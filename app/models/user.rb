class User < ActiveRecord::Base
  ...
  validates :email, presence: true, :if => :no_provider
  validates :email, format: { with: VALID_EMAIL_REGEX }, :if => :no_provider
  validates :email, uniqueness: { case_sensitive: false }, :if => :no_provider
