...
class ConfirmationsControllerTest < ActionController::TestCase
  ...
  test "should create confirmation" do
    assert_difference('Confirmation.count') do
      post :create, :confirmation => { :address => @confirmation.address, :name => @confirmation.name, :total => @confirmation.total, :user_id => @confirmation.user_id }
    end
  ...
  test "should update confirmation" do
    put :update, :id => @confirmation, :confirmation => { :address => @confirmation.address, :name => @confirmation.name, :total => @confirmation.total, :user_id => @confirmation.user_id }
    assert_redirected_to confirmation_path(assigns(:confirmation))
  end
